import { Send, CheckCheck, Eye, XCircle, MessageCircle } from 'lucide-react';
...
const deliveryCards = [
    ...
    { key: 'response', label: 'Response Rate', icon: MessageCircle, iconBg: 'bg-orange-100 text-orange-600', rateColor: 'text-orange-500' },
];
    ...
    return (
        <div className="mb-6 animate-fade-in">
            <div className="mb-3">
                ...
                <div className="text-xs text-gray-500">Track your campaign performance</div>
            </div>
